...
const LandingPage = () => {
  ...
  return (
    ...
    <a target="_blank" href="/studentint" className="bg-gray-800 hover:bg-gray-700 text-white px-6 py-3 rounded-md shadow-md transition duration-300 transform hover:scale-105">Log in </a>
</div>
